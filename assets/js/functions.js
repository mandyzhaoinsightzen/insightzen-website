...
/*    jQuery('.navbar').localScroll({
	...
	function sticky_menu() {
		var menu_scroll = $("body").offset().top+65;
		var scroll_top = $(window).scrollTop();
        $(".header_s1 .ownavigation .navbar-nav li a").css("color","white !important");
		if ( scroll_top > menu_scroll ) {
			$(".header_s").addClass("navbar-fixed-top animated fadeInDown bg-g");
            $(".header_s1 .ownavigation .navbar-nav li a").addClass("fontcolor-gray1");
            $(".logo-img").addClass("logo-img1");
		} else {
			$(".header_s").removeClass("navbar-fixed-top animated fadeInDown bg-g");
            $(".header_s1 .ownavigation .navbar-nav li a").removeClass("fontcolor-gray1");
            $(".logo-img").removeClass("logo-img1");
		}
	}
